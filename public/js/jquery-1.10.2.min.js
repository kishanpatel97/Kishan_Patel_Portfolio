    ...
    (x.fn = x.prototype =
        ...
        x.extend({
            ...
            makeArray: function (e, t) {
                ...
                return (
                    null != e &&
                        (M(Object(e)) ? x.merge(n, "string" == typeof e ? [e] : e) : h.call(n, e)),
                    n
                );
            },
            ...
            (s = at.isXML =
                ...
                (at.uniqueSort = function (e) {
                    var t,
                        ...
                        o = 0;
                    if (
                        ((S = !r.detectDuplicates), (c = !r.sortStable && e.slice(0)), e.sort(A), S)
                    ) {
                ...
                while ((o = s[n++]) && !e.isPropagationStopped()) {
                    ...
                    while ((i = o.handlers[a++]) && !e.isImmediatePropagationStopped())
                        (!e.namespace_re || e.namespace_re.test(i.namespace)) &&
                            ((e.handleObj = i),
                            (e.data = i.data),
                            (r = ((x.event.special[i.origType] || {}).handle || i.handler).apply(
                                o.elem,
                                l
                            )),
                            r !== t &&
                    ...
                    function (e, i, o) {
                        ...
                        return o === t
                            ? a
                                ...
                                : e[i]
                            : (a
                                  ? a.scrollTo(r ? x(a).scrollLeft() : o, r ? o : x(a).scrollTop())
                                  : (e[i] = o),
                              t);
                    },
                    e,
